...
class Sprite {
  ...
  void render() {
    Main.ctx.drawImageScaledFromSource(
      ...
      posX*scaledSpriteSize - Main.player.getCurCharacter().x + Main.canvasWidth/2 - scaledSpriteSize, // x
      posY*scaledSpriteSize - Main.player.getCurCharacter().y + Main.canvasHeight/2, // y
